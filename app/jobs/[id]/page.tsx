...
export default function JobDetailPage() {
  ...
  // ⭐ Posted by label (yahi se naam aayega)
  const isOwner = !!(user && job.postedBy === user.id);
  const postedByLabel = isOwner
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="shadow-2xl border border-[#007BFF]/30 mb-10 overflow-hidden rounded-2xl backdrop-blur-md">
          ...
          <CardContent className="pt-8 pb-10 px-6 sm:px-8">
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-[#002E6E]">
                      {value}
                    </p>
                  </div>
                </div>
            ...
            {/* Description */}
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-[#002E6E] mb-3">
                Job Description
              </h2>
                ...
                <div className="flex-1 bg-[#D1FADF] border border-green-300 rounded-xl p-4 flex items-center gap-3 animate-fade-in">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      Check your dashboard or email for updates.
                    </p>
                  </div>
                </div>
              ) : isSignedIn ? (
        ...
        {applyModal && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto p-8 relative">
              ...
              <h3 className="text-2xl font-bold mb-6 text-[#002E6E]">
                Apply for {job.title}
              </h3>
        ...
        <section className="mt-12">
          <h3 className="text-2xl font-bold text-[#002E6E] mb-6">
            Similar Jobs
          </h3>
