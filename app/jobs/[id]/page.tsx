  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#EAF5FF] via-white to-[#002E6E]/10 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/jobs"
          className="inline-flex items-center text-[#007BFF] hover:text-[#005FBE] mb-6 font-medium"
        >
          <ArrowLeft className="w-4 h-4 mr-2" /> Back to Jobs
        </Link>
            ...
            <div className="flex flex-wrap gap-4">
              {applied ? (
                <div className="flex-1 bg-[#D1FADF] border border-green-300 rounded-xl p-4 flex items-center gap-3 animate-fade-in">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-2xl mr-2">
                    🎉
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      We’ve received your application and sent you a confirmation email.
                    </p>
                  </div>
                </div>
              ) : isSignedIn ? (
                <>
                    ...
                    <div className="fixed inset-0 bg-black/50 z-20 flex items-center justify-center">
                      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-8 relative">
                        ...
                        <form onSubmit={handleApplySubmit}>
                          <input
                            className="w-full bg-gray-100 p-2 rounded mb-3 outline-none cursor-not-allowed"
                            value={user?.fullName ?? ''}
                            disabled
                          />
                          <input
                          ...
                          <textarea
                            name="message"
                            placeholder="Introduce yourself or cover letter (optional)"
                            className="w-full border px-3 py-2 rounded resize-none mb-3"
                            rows={4}
                          />
                  ...
                  <Button
                    variant="outline"
                    className="px-6 text-lg font-semibold hover:bg-[#EAF5FF]"
                  >
        ...
        <section>
          ...
          <p className="text-[#002E6E]/70">
            Explore more opportunities from{' '}
